...
export const server1 = new ServerConfiguration<{  }>("http://localhost:8085", {  })
export const server2 = new ServerConfiguration<{  }>("https://vigilant-fiesta-vgpwvq94pvwc666p-8085.app.github.dev", {  })
